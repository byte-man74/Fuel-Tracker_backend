...
DATABASES = {
    'default': {
        ...
        'NAME': 'pricewiz$V2Database',
        'USER': 'pricewiz',
        'PASSWORD': 'Spiderman-101',
        'HOST': 'pricewiz.mysql.pythonanywhere-services.com',
    }
}
...
#         'NAME': 'pricewiz',
#         'USER': 'PriceWiz',
#         'PASSWORD': 'Spiderman101',
#         'HOST': 'pricewiz.cdmqkzes864f.us-east-1.rds.amazonaws.com',
#         'PORT': '5432',
#     }
# }
...
if USE_S3:
    # aws settings
    AWS_ACCESS_KEY_ID = 'AKIAUODQZ6U7PTHQ7MYX'
    AWS_SECRET_ACCESS_KEY = '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'
